...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, ActivityIndicator, Image, SafeAreaView, Share, Platform, useWindowDimensions } from 'react-native';
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.responsiveWrapper}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Image source={{ uri: images[0] }} style={{ width: contentWidth, height: contentWidth, backgroundColor: colors.border }} resizeMode="cover" />
